...
import io.github.honhimw.ddd.test.domain.setting.event.SettingDeleteEvent;
import io.github.honhimw.ddd.test.domain.setting.event.SettingInsertEvent;
import io.github.honhimw.ddd.test.domain.setting.event.SettingLDeleteEvent;
import io.github.honhimw.ddd.test.domain.setting.event.SettingSelectEvent;
import io.github.honhimw.ddd.test.domain.setting.event.SettingUpdateEvent;
